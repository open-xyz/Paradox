...
const MedicineAnalyzer: React.FC<any> = () => {
	...
	const changeIsGenerated = (newIsGenerated: boolean) => {
	...
	return (
		<div className='flex flex-col items-center justify-start w-full h-auto gap-12'>
			...
			<div>
				{error && <p>{error}</p>}
				{isGenerated && resultJSON && (
					<div className='max-w-2xl'>
						<div className='p-5 my-5 bg-blue-600 border rounded-md min-w-[400px]'>
