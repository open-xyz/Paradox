...
const MedicalReport: React.FC<MedicalReportProps> = () => {
  ...
  const handleSendMessage = async (text: string) => {
    ...
    return Promise.resolve({ data: { choices: [{ message: { content: "Response Content" } }] } });
  };
        ...
        <div className='z-[5] h-full w-[30rem] px-[3rem] py-[2rem] bg-slate-500/10 rounded-xl'>
          <div className='flex flex-col items-center w-full justify-start rounded-md h-[20rem] relative'>
            <form className='w-full'>
              ...
              <p className='text-[0.8rem] text-gray-300 mb-5'>Accepted formats: png, jpg</p>
              <label
          ...
          <button
            ...
            className='w-full py-2 my-10 mt-20 bg-blue-500 rounded hover:bg-blue-600'
          >
            Generate Report
          </button>
        </div>
